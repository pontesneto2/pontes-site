                ...
                {(() => {
                  ...
                  return (
                    <motion.article
                      ...
                      className="spotlight-card relative group rounded-3xl overflow-hidden border border-white/10 shadow-2xl grid md:grid-cols-2 items-stretch hover:border-white/20 hover:-translate-y-1 transition-all duration-300"
                    >
                  ...
                  {featuredProjects.slice(1).map((project, index) => {
                    ...
                    return (
                      <motion.article
                        ...
                        variants={fadeUpItem}
                        onMouseMove={handleSpotlightMove}
                        className="spotlight-card group snap-start shrink-0 w-[88%] sm:w-[calc(50%-1rem)] rounded-3xl overflow-hidden border border-white/10 shadow-2xl flex flex-col hover:border-white/20 hover:-translate-y-1 transition-all duration-300"
                      >
