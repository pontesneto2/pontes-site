          ...
          <div className="p-6 sm:p-8">
            ...
            <div className="mt-4 grid grid-cols-1 gap-3.5 sm:grid-cols-2">
              ...
              <label className="block">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-white/15 bg-white/[0.03] px-4 py-2.5 text-sm text-white placeholder:text-zinc-500 transition-colors hover:border-white/30 focus:border-violet-400/60 focus:outline-none focus:ring-2 focus:ring-violet-500/25"
                />
              </label>
            </div>
            ...
            <div className="mt-6 flex flex-col gap-2.5">
              <button
                ...
                className="group flex w-full items-center justify-center gap-2 rounded-full bg-gradient-to-r from-violet-600 to-fuchsia-500 px-7 py-3.5 text-sm font-semibold text-white shadow-lg shadow-violet-500/30 transition-all hover:scale-[1.01] hover:shadow-xl hover:shadow-fuchsia-500/40 hover:brightness-110 disabled:cursor-not-allowed disabled:opacity-40 disabled:shadow-none disabled:hover:scale-100 disabled:hover:brightness-100"
              >
                {status === "loading" ? (
